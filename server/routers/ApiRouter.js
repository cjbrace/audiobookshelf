...
class ApiRouter {
  ...
  init() {
    ...
    this.router.get('/libraries/:id/series-review/source-import/status', LibraryController.middleware.bind(this), SeriesReviewController.getSourceImportStatus.bind(this))
    this.router.get('/libraries/:id/series-review/management', LibraryController.middleware.bind(this), SeriesReviewController.getManagementData.bind(this))
    this.router.get('/libraries/:id/series-review/catalog', LibraryController.middleware.bind(this), SeriesReviewController.getCatalogs.bind(this))
    this.router.get('/libraries/:id/series-review/catalog/:catalogId', LibraryController.middleware.bind(this), SeriesReviewController.getCatalogDetail.bind(this))
    ...
    this.router.post('/libraries/:id/series-review/catalog/:catalogId/check', LibraryController.middleware.bind(this), SeriesReviewController.checkCatalog.bind(this))
    this.router.post('/libraries/:id/series-review/catalog/:catalogId/uncheck', LibraryController.middleware.bind(this), SeriesReviewController.uncheckCatalog.bind(this))
    ...
    this.router.post('/series-review/suggestions/:suggestionId/alias', SeriesReviewController.aliasSuggestion.bind(this))
    this.router.post('/series-review/suggestions/:suggestionId/rename', SeriesReviewController.renameSuggestion.bind(this))
    ...
    this.router.post('/libraries/:id/series-review/catalog/:catalogId/normalize-name', LibraryController.middleware.bind(this), SeriesReviewController.normalizeCatalogSeriesName.bind(this))
    ...
    this.router.post('/quick-match-sessions/:id/duplicates/process-group', QuickMatchSessionController.processDuplicateGroup.bind(this))
    this.router.post('/quick-match-sessions/:id/duplicates/process-done', QuickMatchSessionController.processDoneDuplicateGroups.bind(this))
